...
//	private final static String CLIENT_ID = "tvpmp5NFQxDcEEN45i4P";
//	private final static String CLIENT_SECRET = "pmkx4QFc4O";
//	private final static String REDIRECT_URI = "http://localhost/guest/naverlogin.do";
